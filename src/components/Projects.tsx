...
export default function Projects() {
    ...
    return (
        // Adding h-[400vh] to make room for scroll length, and relative so sticky sticks to it
        <section ref={targetRef} id="projects" className="relative h-[400vh] bg-[#0a0a0a]">
            ...
            <div className="sticky top-0 h-screen w-full overflow-hidden flex flex-col justify-center">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[70vw] h-[70vw] md:w-[45vw] md:h-[45vw] bg-[var(--color-brand-lime)]/20 blur-[130px] rounded-full pointer-events-none" />

                {/* Header pinned at the top of the sticky element */}
                <div className="absolute top-24 left-0 right-0 z-[100] px-6 md:px-16 text-center">
                    <h2 className="font-serif text-5xl md:text-7xl text-white mb-4 drop-shadow-lg">
                ...
                <div className="relative w-full h-[60vh] max-h-[600px] flex items-center justify-center perspective-[1000px] mt-12 md:mt-24 pointer-events-none">
